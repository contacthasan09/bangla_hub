...
class _SplashScreenState extends State<SplashScreen> 
  ...
  final Color _platinum = const Color(0xFFE5E4E2);
  final Color _offWhite = const Color(0xFFF8F8F8);
  final Color _lightGold = const Color(0xFFFFF8E1);
  ...
  void initState() {
    ...
    _fadeAnimation = Tween<double>(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(
        ...
        curve: const Interval(0.0, 0.19, curve: Curves.easeInOut), // 0-0.75s of 4s
      ),
    );
    ...
    _textFadeAnimation = Tween<double>(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(
        parent: _animationController,
        curve: const Interval(0.4, 0.8, curve: Curves.easeInOut), // 1.6-3.2s of 4s
      ),
    );
    ...
    _scaleAnimation = Tween<double>(begin: 0.3, end: 1.0).animate(
      CurvedAnimation(
        parent: _animationController,
        curve: const Interval(0.2, 0.7, curve: Curves.elasticOut), // 0.8-2.8s of 4s
      ),
    );
    ...
    _slideAnimation = Tween<Offset>(
      ...
      CurvedAnimation(
        parent: _animationController,
        curve: const Interval(0.5, 1.0, curve: Curves.easeOutBack), // 2.0-4.0s of 4s
      ),
    );
