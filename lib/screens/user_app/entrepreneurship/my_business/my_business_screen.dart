// lib/screens/user_app/my_business/my_business_screen.dart
...
class _MyBusinessList extends StatelessWidget {
  const _MyBusinessList();
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Your Business Listings Will Appear Here',
              style: GoogleFonts.poppins(
            ...
            Text(
              'Business listings you create will be shown here after approval',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            Text(
              'Your submitted business listings are waiting for admin approval',
              style: GoogleFonts.inter(
                fontSize: isTablet ? 14 : 12,
                color: Colors.grey[500],
              ),
