// lib/screens/user_app/my_education/my_education_screen.dart
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class MyEducationScreen extends StatefulWidget {
  const MyEducationScreen({Key? key}) : super(key: key);
...
class _MyEducationList extends StatelessWidget {
  const _MyEducationList();
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Your Education Content Will Appear Here',
              style: GoogleFonts.poppins(
            ...
            Text(
              'Educational content you create will be shown here after approval',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            Text(
              'Your submitted educational content is waiting for admin approval',
              style: GoogleFonts.inter(
                fontSize: isTablet ? 14 : 12,
                color: Colors.grey[500],
              ),
